...
def tokenize_with_ner(example: str):
    ...
    computed_mapped_to_ids = [computed[x]
                              if x is not None else -100 for x in word_ids]


result = extract_entities(
    ['<e-start>generate</e-start> random words <e-statement>white hair, glasses, skirt</e-statement> and more random words'], 'generate_')
