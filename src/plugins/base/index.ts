		...
		return [
			{
				...
				examples: [
					...
					'[G|g]enerate a man with a big jaw <params:size:50x10> <params:seed:711169780>',
					'[G|g]enerate #unk',
					'[G|g]enerate school',
					'[G|g]enerate a purp dank',
					'[G|g]enerate [white hair | blue eyes | #unk dress | pink lips ], #unk, [skirt | #unk skin]',
					'[G|g]enerate red trees, #unk, two tables',
					'[G|g]enerate a man with a red and blue hay',
					'[G|g]enerate three little pigs playing on the beach',
					...
					'[G|g]enerate micheal jackson in a blue bugatti',
