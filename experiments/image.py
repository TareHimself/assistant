from diffusers import StableDiffusionPipeline, DPMSolverMultistepScheduler, StableDiffusionLatentUpscalePipeline, AutoencoderKL, LDMSuperResolutionPipeline
import torch
import io
...
low_res_image = pipeline(FINAL_PROMPT,
                         negative_prompt=NEGATIVE_PROMPT, num_inference_steps=200, height=448, width=640, guidance_scale=7, generator=generator).images
low_res_image[0].save('generated.png')
